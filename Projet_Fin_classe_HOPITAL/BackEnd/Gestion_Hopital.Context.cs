...
namespace Projet_Fin_classe_HOPITAL.BackEnd
{
    ...
    public partial class Gestion_HopitalEntities16 : DbContext
    {
        public Gestion_HopitalEntities16()
            : base("name=Gestion_HopitalEntities16")
        {
        }
        ...
        public virtual int Modifier_rePatient_web(string cin, string nom, string prenom, string tele, Nullable<System.DateTime> date_re)
        {
            var cinParameter = cin != null ?
                new ObjectParameter("cin", cin) :
                new ObjectParameter("cin", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Modifier_rePatient_web", cinParameter, nomParameter, prenomParameter, teleParameter, date_reParameter);
        }
        ...
        public virtual int Supprimer_rePatient_web(string cin)
        {
            var cinParameter = cin != null ?
                new ObjectParameter("cin", cin) :
                new ObjectParameter("cin", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Supprimer_rePatient_web", cinParameter);
        }
        ...
        public virtual int SupprimerTest(Nullable<int> id_doc, string nom_test)
        {
            var id_docParameter = id_doc.HasValue ?
                new ObjectParameter("id_doc", id_doc) :
                new ObjectParameter("id_doc", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SupprimerTest", id_docParameter, nom_testParameter);
        }
    
        public virtual ObjectResult<AfficherOrdonnanceMedicamentPrint_Result> AfficherOrdonnanceMedicamentPrint(Nullable<int> id_om)
        {
            var id_omParameter = id_om.HasValue ?
                new ObjectParameter("id_om", id_om) :
                new ObjectParameter("id_om", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AfficherOrdonnanceMedicamentPrint_Result>("AfficherOrdonnanceMedicamentPrint", id_omParameter);
        }
    }
}
